...
public class HirataAcademiaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Date hoje = new Date();
		Endereco enderecoAluno = new Endereco("56330700", "356", "Caminho do Sol", "rua quintino marcelo", "Petrolina",
				"PE");
		Endereco enderecoProf = new Endereco("6354", "1312", "boa vista", "rua da ufape", "petrolina", "PE");
		rp.save(new Plano(100, "trimestral"));
		// rp2.save(new Aluno("filipe", hoje, 6354534352l, enderecoAluno, 21f, 84f,
		// 1.86f, 14f,"87988848646", 0));
		rp2.save(new Professor("piu", hoje, "12345678912", enderecoProf, 0));
		cadastroTeste.save(new Aluno("filipe", new SimpleDateFormat("dd/MM/yyyy").parse("07/08/2003"), "12345678901",
				enderecoAluno, 84f, 1.86f, 14f, "879888489411"));
	}

	// String nome, Date dataDeNascimento, long cpf, Endereco endereco, float imc,
