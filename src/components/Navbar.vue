  ...
  <div>
    <div id="nav">
      <v-app-bar app id="nav">
        <v-app-bar-nav-icon @click="drawer = !drawer" color=#ffff ></v-app-bar-nav-icon>
      ...
      <!--Barra de William-->
      <v-navigation-drawer v-model="drawer" app id="nav" color="white">
        <v-list-item>
        ...
        <template>
          <v-card class="mx-auto" width="300" id="nav">
            <v-list dense nav>
