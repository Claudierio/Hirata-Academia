<template>
      ...
      <div class="page-content">
        <div class="form-v10-content">
          <form class="form-detail" id="myform">
            <div class="form-left">
              <h2>Previsão de Lucro:</h2>
              <h2>Total de Alunos:</h2>
              <v-divider></v-divider>
              <h3>- Total de Planos Mensais:</h3>
              <h3>- Total de Planos Trimestrais:</h3>
              <h3>- Total de Planos Anuais:</h3>
  ...
  export default {
    ...
    methods: {
      lucro() {
        ContadorService.lucro().then(
          response => {
            this.lucroTotal = response.data;
          }
        );
      },
      totalAlunos() {
        ContadorService.totalAluno().then(
          response => {
      ...
      totalMensal() {
        ContadorService.totalMensal().then(
          response => {
            this.mensal = response.data;
          }
        );
      },
      totalTrimestral() {
        ContadorService.totalTrimestral().then(
          response => {
            this.trimestral = response.data;
          }
        );
      },
      totalAnual() {
        ContadorService.totalAnual().then(
          response => {
