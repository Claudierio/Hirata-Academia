    ...
    <div class="page-content">
      <div class="form-v10-content">
        <form class="form-detail" id="myform">
          <div class="form-left">
            <h2>Cadastrar Contador</h2>
            <div class="form-row">
              <input type="text" v-model="contador.nome" name="primeiro_nome" id="primeiro_nome" class="input-text"
            ...
            <div class="form-group">
              <div class="form-row form-row-1">
                <input type="text" maxlength="11" minlength="11" v-model="contador.cpf" name="cpf" id="cpf" class="input-text" placeholder="CPF"
                  required>
              </div>
              <div class="form-row form-row-2">
                <input type="date" v-model="contador.dataDeNascimento" name="date" class="date" id="date"
                  placeholder="Data de Nascimento" value="2010-06-01" required>
              </div>
            </div>
            <div class="form-row">
              <input type="text" v-model="contador.crc" name="crc" id="crc" class="input-text" placeholder="CRC"
                required>
              <span class="select-btn">
                <i class="zmdi zmdi-chevron-down"></i>
              </span>
            ...
            <div class="form-row">
              ...
              <select name="title" v-model="contador.turno">
            ...
            <div class="form-row form-row-2">
              <input type="text" v-model="contador.salario" name="salario" id="salario" class="input-text" required
                placeholder="Salario">
            </div>
          </div>
          <div class="form-right">
            <h2>Detalhes</h2>
            <div class="form-row">
              <input type="text" v-model="contador.endereco.rua" name="street" class="street" id="street"
                placeholder="Rua" required>
            </div>
            <div class="form-row">
              <input type="text" v-model="contador.endereco.bairro" name="bairro" class="bairro" id="bairro"
                placeholder="Bairro" required>
            </div>
            <div class="form-group">
              <div class="form-row form-row-1">
                <input type="text" v-model="contador.endereco.cep" name="cep" class="cep" id="cep" placeholder="CEP"
                  required>
              </div>
              <div class="form-row form-row-2">
                <input type="text" v-model="contador.endereco.numero" name="numero" class="numero" id="numero"
            ...
            <div class="form-group">
              <div class="form-row form-row-1">
                <input type="text" v-model="contador.endereco.uf" name="uf" class="uf" id="uf" placeholder="UF"
                  required>
              </div>
              <div class="form-row form-row-2">
                <input type="text" v-model="contador.endereco.municipio" name="cidade" class="cidade" id="cidade"
                  placeholder="Cidade" required>
              </div>
            </div>
            <div class="form-row">
              <input type="text" v-model="contador.contato" name="telefone_celular" id="telefone_celular"
...
export default {
  ...
  methods: {
    cadastrar() {
      ...
      ContadorService.create(this.contador).then(response => {
    ...
    continuar() {
      this.$router.push({ name: '/CadastrarContador' });
    }
  },
