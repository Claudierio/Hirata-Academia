<template>
        ...
        <div class="form-v10-content">
          <form class="form-detail" action="#" method="post" id="myform">
            <div class="form-left">
              ...
              <div class="form-row">
                <input type="text" name="primeiro_nome" id="primeiro_nome" class="input-text" placeholder="Nome do(a) aluno(a)"
                    required>
              ...
              <div class="form-group">
                <div class="form-row form-row-1">
                  <input type="text" name="cpf" id="cpf" class="input-text" placeholder="CPF do(a) aluno(a)"
                    required>
                </div>
                <div class="form-row form-row-2">
                    <input type="date" name="date" class="date" id="date" placeholder="Data de Nascimento" value="" required>
                </div>
              </div>
              <div class="form-row">
              ...
              <div class="form-row">
                <label for="Objetivo">Escolha seu objetivo:</label>
                <select class="test" name="objetivo" id="objetivo" v-model="treino">
                    <option value="">Ganho de Massa</option>
                    <option value="">Perca de Peso</option>
                    <option value="">Definir Músculos</option>
                </select>
              </div>
              <div class="form-group">
              ...
              <div class="input-container">
                  <input type="submit" class="submit-btn" value="Criar Ficha">
                </div>
            </div>
          </form>
        </div>
  ...
  <script>
  export default {
    treino: ['Perda de peso', 'Ganho de massa', 'Definir Músculo'],
  }
  </script>i
