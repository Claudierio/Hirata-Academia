    ...
    <div class="page-content">
      <div class="form-v10-content">
        <form class="form-detail" id="myform">
          <div class="form-left">
            <h2>Cadastrar Professor Estagiário</h2>
            <div class="form-row">
              <input type="text" v-model="professorEstagiario.nome" name="primeiro_nome" id="primeiro_nome"
            ...
            <div class="form-group">
              <div class="form-row form-row-1">
                <input type="text" maxlength="11" minlength="11" v-model="professorEstagiario.cpf" name="cpf" id="cpf"
                  class="input-text" placeholder="CPF" required>
              </div>
              <div class="form-row form-row-2">
                <input type="text" v-model="professorEstagiario.salario" name="salario_estagiario"
                  id="salario_estagiario" class="input-text" required placeholder="Salario">
              </div>
            </div>
            <div class="form-group">
              <div class="form-row form-row-3">
                <label for="birthday">Início de Estágio:</label>
                <input type="date" v-model="professorEstagiario.inicioEstagio" name="date" class="date" id="date"
                  placeholder="Data de Nascimento" value="2022-09-28" required>
              </div>
              <div class="form-row form-row-4">
                <label for="birthday">Fim de Estágio:</label>
                <input type="date" v-model="professorEstagiario.fimEstagio" name="date" class="date" id="date"
            ...
            <div class="form-group">
              <div class="form-row form-row-1">
                ...
                <select name="title" v-model="professorEstagiario.turno">
              ...
              <div class="form-row form-row-2">
                ...
                <input type="date" v-model="professorEstagiario.dataDeNascimento" name="date" class="date" id="date"
                  placeholder="Data de Nascimento" value="" required>
              </div>
            </div>
          </div>
          <div class="form-right">
            <h2>Detalhes</h2>
            <div class="form-row">
              <input type="text" v-model="professorEstagiario.endereco.rua" name="street" class="street" id="street"
                placeholder="Rua" required>
            </div>
            <div class="form-row">
              <input type="text" v-model="professorEstagiario.endereco.bairro" name="bairro" class="bairro" id="bairro"
                placeholder="Bairro" required>
            </div>
            <div class="form-group">
              <div class="form-row form-row-1">
                <input type="text" v-model="professorEstagiario.endereco.cep" name="cep" class="cep" id="cep"
                  placeholder="CEP" required>
              </div>
              <div class="form-row form-row-2">
                <input type="text" v-model="professorEstagiario.endereco.numero" name="numero" class="numero"
                  id="numero" placeholder="Número da casa" required>
                <span class="select-btn">
                  <i class="zmdi zmdi-chevron-down"></i>
                </span>
              </div>
            ...
            <div class="form-group">
              <div class="form-row form-row-1">
                <input type="text" v-model="professorEstagiario.endereco.uf" name="uf" class="uf" id="uf"
                  placeholder="UF" required>
              </div>
              <div class="form-row form-row-2">
                <input type="text" v-model="professorEstagiario.endereco.municipio" name="cidade" class="cidade"
                  id="cidade" placeholder="Cidade" required>
              </div>
            </div>
            <div class="form-row">
              <input type="text" v-model="professorEstagiario.contato" name="telefone_celular" id="telefone_celular"
...
export default {
  ...
  methods: {
    cadastrar() {
      console.log(this.professorEstagiario)
      alert(this.professorEstagiario)
      ProfessorEstagiarioService.create(this.professorEstagiario).then(response => {
